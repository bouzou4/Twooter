...
// closure that returns a function that takes an http.ResponseWriter and http.Request and extracts the title from the request path, and validates it with the TitleValidator regular expression
